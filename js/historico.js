      ...
      ${animes.map(item => {
        ...
        return `
          <div class="history-card" style="background:#12141a; border:1px solid rgba(134,239,172,0.08); border-radius:20px; padding:24px; position:relative; overflow:hidden;">
            ...
            <div style="position:absolute; top:0; right:0; width:100%; height:100%; background:linear-gradient(to bottom, rgba(18,20,26,0.92) 0%, #12141a 100%), url('${anime.image_url}'); background-size:cover; background-position:center; z-index:0; opacity:0.15;"></div>
